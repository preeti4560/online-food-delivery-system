...
class Hotel ( models . Model ) : 
	...
	hotel_rating = models . IntegerField ( null = True , default = 0) 
	hotel_image = models . CharField ( max_length = 1000 , null = True , default = None )
...
class  Order ( models . Model ) : 
	...
	user_hotel_rating = models . IntegerField ( null = True )
	user_delivery_boy_rating = models . IntegerField ( null = True )  
